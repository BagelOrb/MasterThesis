...
public class TKrpropMomentumUnit extends LearningMechanism<TKrpropMomentumUnit.TKrpropMomentumUnitState> {
...
//		for (int f = 0 ; f< params.nFeatures; f++)
//		{
//			learningState.biasVelocities[f] *= params.netParams.alpha_momentum; // .1 * TODO: implement this option?
//			learningState.biasVelocities[f] += cnnDoubleLayer.biasesDerivatives[f] * params.netParams.etaWeights;// ; // TODO: implement this option?
//			
//			// extra slowdown when derivative and velocity are of opposite sign
////			if (learningState.biasVelocities[f] * cnnDoubleLayer.biasesDerivatives[f] < 0) // TODO: move this to a new kind of Momentum2.java ?
////				learningState.biasVelocities[f] += cnnDoubleLayer.biasesDerivatives[f] * params.netParams.etaWeights; // ;// TODO: implement this option?
//			
//			Debug.checkNaN(learningState.biasVelocities[f]);
//			
//			if (Math.abs(learningState.biasVelocities[f]) > 10)
//				learningState.biasVelocities[f] = 10 * Math.signum(learningState.biasVelocities[f]);
//			
//			cnnDoubleLayer.biases[f] += Math2.limit(-1E6, learningState.biasVelocities[f], 1E6); 
