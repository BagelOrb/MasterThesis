...
public class MomentumBackup extends LearningMechanism<MomentumBackup.MomentumState>{
	...
	private double alpha_momentum;
	private double etaWeights;

	public MomentumBackup(double alpha_momentum, double etaWeights) {
